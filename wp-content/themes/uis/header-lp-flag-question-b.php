            ...
            <div class="header-form">
                <div class="header-form-inner">
                    ...
                    <form class="register_form_lp_yp" action="<?php echo esc_url(admin_url('admin-post.php')) ?>" method="post">
                        ...
                        <input type="hidden" name="University_Degree__c" value="" />
                        <input type="hidden" name="Monthly_Income_Over_2000__c" value="" />
            ...
            <div class="content-qu">
                <ul class="questions">
                    <li id="qu-steep01" class="steeps steeps_active">
                        ...
                        <h2>Which of the following best describes your level of English?</h2>
                        <div class="button button_no" id="btnNoEnglish">No English</div>
                        <div class="button button_yes" id="btnIntermediate">Intermediate</div>
                        <div class="button button_no" id="btnAdvanced">Advanced</div>
                    </li>
                    <li id="qu-steep02" class="steeps">
                        ...
                        <h2>Do you hold a university degree?</h2>
                        <div class="button button_yes" id="btnYesQuestion2">yes</div>
                        <div class="button button_no" id="btnNoQuestion2">no</div>
                    </li>
                    <li id="qu-steep03" class="steeps">
                        ...
                        <h2>Is your average monthly income over $2,000?</h2>
