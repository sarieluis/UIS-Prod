<?php if( get_query_var('pagename') != 'login' && !is_profile() && basename( get_page_template() ) != 'template.fibonatix-thankyou-page.php' ) : ?>
        ...
        <div class="container">
            <div class="footer-bottom_inner">
                <div class="footer-copy">
                    <p>All rights reserved to U.M.C Ltd. Eichhornstraße 3, 10785 Berlin, Germany </p>
