...
if( $case->Evaluation_Status__c == 'Completed' )
  $disable_step_1 = true;
            ...
            <div class="container-md">
                ...
                <div class="tabs-wrapper">
                    <div class="tabs-header">
                        ...
                        <div class="tab-toggle tab-toggle_disabled" data-tab="equal-7">Documentation Collection</div>
                        <div class="tab-toggle tab-toggle_disabled" data-tab="equal-8">Government Letters</div>
                    </div>
                    <div class="tabs-body">
                        ...
                        <div class="tab-content" data-tab="equal-7">Documentation Collection</div>
                        <div class="tab-content" data-tab="equal-8">Government Letters</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="popup-overlay">
            <div class="popup">
                <div class="popup-body">
                    <i class="i-exclamation"></i>
                    <p>Do you wish to save changes?</p>
                </div>
                <div class="popup-actions">
                    <a href="#" data-type="yes" class="btn btn_grey">Yes</a>
                    <a href="#" data-type="no" class="btn btn_grey">No</a>
                    <a href="#" data-type="cancel" class="btn btn_grey">Cancel</a>
                </div>
            </div>
        </div>
