...
//                $sf_ready_array[''] = $data['cv-file'];
            ...
            case 7:
                ...
                if ( $data['other-file_2-file'] != '' && ! $case->FS_Other_File_2__c){
                    ...
                    $documentsUploaded .= "Other File #2";
                }
                ...
                if ( $data['other-file_3-file'] != '' && ! $case->FS_Other_File_3__c){
                    ...
                    $documentsUploaded .= "Other File #3";
                }

                $to = "sarielh90@gmail.com";
                $subject = "New Documents Uploaded";
                $txt = "Documents : " .$documentsUploaded. ", Case Number : " .$case->CaseNumber;
                $headers = "From: test@uiscanada.com";
