...
$video_url = is_array( $video ) && isset( $video['url'] ) ? $video['url'] : get_stylesheet_directory_uri() . '/inmanage/lp-pages/young_professionals/assets/video/video-desktop.webm';
    ...
    <div class="container">
      ...
      <div class="header-form">
        <div class="header-form-inner">
		  ...
		  <?php echo "<script>console.log(admin_url('admin-post.php'));</script>";  ?>
